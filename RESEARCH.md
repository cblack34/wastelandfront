...
- [ ] From the P2 bundle (#53): does the mono-type 3+2 tier require the 2 off-type heroes to match each other?; Missile→Aircraft and Aircraft→Tank counter magnitudes + additive-vs-multiplicative stacking (combat-log test); Swift's Missile type lacks a Tier-1 hit (lastwar.wiki spot-check); Dielectric Ceramic VIP 6 vs 9 (theriagames says 9; cpt-hedge VIP-store page 403s); "Season Merit Medal" as the likely real store-currency name; Black Market ~600/day cash cap (Tier-3 only; cpt-hedge page 403s)
